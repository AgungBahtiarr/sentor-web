    ...
    async function handleAnalyze() {
        ...
        try {
            ...
            const response = await fetch(
                `${baseUrl}/api/trading/analyze?${params.toString()}`,
            );
    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="text-center mb-12 animate-fade-in">
            ...
            <p class="text-xl text-base-content/70 max-w-2xl mx-auto mb-6">
                Advanced Fractal Model Trading Analysis powered by AI. Get
                accurate BUY/SELL signals with precise entry, stop loss, and
                take profit levels.
            </p>
            <div
                class="flex items-center justify-center gap-2 text-base-content/60"
            >
                <Star class="w-5 h-5 text-warning fill-current" />
                <span
                    >Trusted by {stats.activeUsers.toLocaleString()} traders</span
                >
                <span>•</span>
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-12">
            ...
            >
                <div class="card-body text-center">
                    ...
                    <p class="text-sm text-base-content/70">
                        High confidence BUY/SELL signals based on fractal
                        pattern analysis
                    </p>
                </div>
            </div>
            ...
            >
                <div class="card-body text-center">
                    <div
                        class="w-16 h-16 mx-auto mb-4 rounded-full bg-secondary/10 flex items-center justify-center"
                    >
                        <BarChart class="w-8 h-8 text-secondary" />
                    </div>
                    <h3 class="text-lg font-bold mb-2">Multi-Timeframe</h3>
                    <p class="text-sm text-base-content/70">
                        Analyze across bias, structure, and entry timeframes for
                        precision
                    </p>
                </div>
            </div>
            ...
            >
                <div class="card-body text-center">
                    ...
                    <p class="text-sm text-base-content/70">
                        Automatic stop loss, take profit, and risk:reward
                        calculation
                    </p>
                </div>
            </div>
            ...
            >
                <div class="card-body text-center">
                    ...
                    <p class="text-sm text-base-content/70">
                        Detailed explanations for every trading decision and
                        signal
                    </p>
                </div>
            </div>
            ...
            <div class="grid gap-6 md:grid-cols-3">
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        <div class="flex items-center gap-4 mb-4">
                            <div
                                class="w-12 h-12 rounded-full bg-primary text-primary-content flex items-center justify-center text-xl font-bold"
                            >
                                1
                            </div>
                        ...
                        <p class="text-base-content/70">
                            Input any Binance trading pair you want to analyze.
                            Use quick select for popular options.
                        </p>
                    </div>
                </div>
                ...
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        <div class="flex items-center gap-4 mb-4">
                            <div
                                class="w-12 h-12 rounded-full bg-secondary text-secondary-content flex items-center justify-center text-xl font-bold"
                            >
                                2
                            </div>
                        ...
                        <p class="text-base-content/70">
                            Our AI analyzes fractal patterns across multiple
                            timeframes and detects optimal entry points.
                        </p>
                    </div>
                </div>
                ...
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        <div class="flex items-center gap-4 mb-4">
                            <div
                                class="w-12 h-12 rounded-full bg-accent text-accent-content flex items-center justify-center text-xl font-bold"
                            >
                                3
                            </div>
                        ...
                        <p class="text-base-content/70">
                            Receive actionable trade signals with entry, stop
                            loss, take profit, and detailed AI reasoning.
                        </p>
                    </div>
                </div>
            </div>
        ...
        >
            <div class="card-body">
                <h2
                    class="card-title text-2xl font-bold mb-6 flex items-center gap-2"
                >
                ...
                <div class="card-body">
                    <div class="flex flex-col items-center justify-center py-8">
                        <div class="flex items-center gap-4 mb-6">
                            <div
                                class="w-3 h-3 rounded-full {loadingStep >= 1
                                    ? 'bg-primary'
                            ...
                            <div class="w-16 h-1 bg-base-300 rounded">
                                <div
                                    ...
                                    style="width: {loadingStep >= 1
                                        ? '100%'
                                        : '0%'}"
                                ></div>
                            </div>
                            <div
                                class="w-3 h-3 rounded-full {loadingStep >= 2
                                    ? 'bg-primary'
                                    : 'bg-base-300'} transition-colors duration-300"
                            ></div>
                            <div class="w-16 h-1 bg-base-300 rounded">
                                <div
                                    class="h-full bg-primary rounded transition-all duration-300"
                                    style="width: {loadingStep >= 2
                                        ? '100%'
                                        : '0%'}"
                                ></div>
                            </div>
                            <div
                                class="w-3 h-3 rounded-full {loadingStep >= 3
                                    ? 'bg-primary'
                                    : 'bg-base-300'} transition-colors duration-300"
                            ></div>
                        </div>
        ...
        {#if result && meta && !isLoading}
            <div class="space-y-6 animate-fade-in">
                ...
                <div
                    class="card bg-base-100 shadow-xl text-base-content overflow-hidden"
                >
                    <div class="card-body">
                        <div class="grid gap-4 md:grid-cols-5">
                            <div class="text-center p-4 bg-base-200 rounded-xl">
                                ...
                                <div
                                    class="text-xs mt-1 {result.marketData
                            ...
                            <div class="text-center p-4 bg-base-200 rounded-xl">
                                ...
                                <div class="text-xs mt-1 opacity-70">
                                    Confidence: {result.signal.confidence.toFixed(
                                        1,
                                    )}%
                                </div>
                            </div>
                            ...
                            {#if meta.fractalData?.dailyBias}
                                <div
                                    class="text-center p-4 bg-base-200 rounded-xl"
                                >
                                    <div class="text-sm opacity-70 mb-1">
                                        Setup Phase
                                    </div>
                                    ...
                                    <div
                                        class="text-xs mt-1 opacity-70 flex items-center justify-center gap-1"
                                    >
                                ...
                                >
                                    ...
                                    <div class="text-lg font-bold">
                                        <span
                                            class={`badge ${getBiasClass(meta.fractalData.dailyBias.type)} badge-lg`}
                                        >
                            ...
                            <div class="text-center p-4 bg-base-200 rounded-xl">
                                ...
                                <div
                                    class="text-2xl flex justify-center items-center gap-2"
                                >
                                    <Circle
                                        class="w-6 h-6 {meta.riskLevel === 'LOW'
                                            ? 'text-success'
                                            : meta.riskLevel === 'MEDIUM'
                                              ? 'text-warning'
                                              : 'text-error'}"
                                        fill={meta.riskLevel === "LOW"
                                            ? "currentColor"
                                            : meta.riskLevel === "MEDIUM"
                                              ? "currentColor"
                                              : "currentColor"}
                ...
                {#if meta.tradeParameters}
                    <div
                        class="card bg-base-100 shadow-xl border-l-4 border-primary overflow-hidden"
                    >
                        <div class="card-body">
                            <h3
                            ...
                            <div class="grid gap-4 md:grid-cols-4">
                                <div class="p-4 bg-base-200 rounded-xl">
                                    ...
                                    >
                                        {meta.tradeParameters.entryZone.toFixed(
                                            2,
                                        )}
                                    </div>
                                    <div
                                ...
                                <div class="p-4 bg-base-200 rounded-xl">
                                    ...
                                    <div class="text-3xl font-bold text-error">
                                        {meta.tradeParameters.stopLoss.toFixed(
                                            2,
                                        )}
                                    </div>
                                    <div
                                ...
                                <div class="p-4 bg-base-200 rounded-xl">
                                    ...
                                    >
                                        {meta.tradeParameters.takeProfit.toFixed(
                                            2,
                                        )}
                                    </div>
                                    <div
                                ...
                                <div class="p-4 bg-base-200 rounded-xl">
                                    ...
                                    >
                                        1:{meta.tradeParameters.riskReward.toFixed(
                                            2,
                                        )}
                                    </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            >{result.signal.confidence.toFixed(
                                                1,
                                            )}%</span
                                        >
                                    </div>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                        <span
                                            class={`text-sm font-bold ${meta.riskLevel === "LOW" ? "text-success" : meta.riskLevel === "MEDIUM" ? "text-warning" : "text-error"}`}
                                        >
                                            {meta.riskLevel}
                                        </span>
                                    </div>
                                    ...
                                    >
                                        <div
                                            class={`h-3 rounded-full transition-all duration-1000 ${meta.riskLevel === "LOW" ? "bg-success" : meta.riskLevel === "MEDIUM" ? "bg-warning" : "bg-error"}`}
                                            style="width: {meta.riskLevel ===
                                            'LOW'
                                                ? '33%'
                                                : meta.riskLevel === 'MEDIUM'
                                                  ? '66%'
                                ...
                                {#if meta.tradeParameters}
                                    <div>
                                        ...
                                        >
                                            <div
                                                class="bg-secondary h-3 rounded-full transition-all duration-1000"
                                                style="width: {Math.min(
                                                    meta.tradeParameters
                                                        .riskReward * 33.33,
                                                    100,
                                                )}%"
                                            ></div>
                                ...
                                {#if meta.timeframes}
                                    ...
                                    >
                                        <div class="flex items-center gap-2">
                                            ...
                                            ></div>
                                            <span class="text-sm font-semibold"
                                                >Structure Timeframe</span
                                            >
                                        </div>
                                        <span
                                            class="text-lg font-bold text-secondary"
                                            >{meta.timeframes.structure}</span
                                        >
                                    </div>
                                    ...
                                    >
                                        <div class="flex items-center gap-2">
                                            ...
                                            ></div>
                                            <span class="text-sm font-semibold"
                                                >Entry Timeframe</span
                                            >
                                        </div>
                                        <span
                                            class="text-lg font-bold text-accent"
                                            >{meta.timeframes.entry}</span
                                        >
                                    </div>
                                {/if}
                            </div>
                                        ...
                                        {#each meta.fractalData.poi.slice(0, 9) as poi}
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                    <span
                                                        class="text-xs px-2 py-1 rounded-full badge badge-outline"
                                                    >
                                                        {poi.price.toFixed(4)}
                                                    </span>
                                                </div>
                                    ...
                                    <div class="space-y-3">
                                        {#each meta.fractalData.cisds
                                            ...
                                            >
                                                ...
                                                >
                                                    <span
                                                        class={`badge ${cisd.type === "BULLISH" ? "badge-success" : "badge-error"} badge-sm gap-1`}
                                                    >
                ...
                <div class="card bg-base-100 shadow-xl overflow-hidden">
                    <div class="card-body">
                        ...
                        {#if !collapsedSections.bias}
                            <div
                                class="mt-4 transition-all duration-300 space-y-4"
                            >
                                    ...
                                    <div class="p-4 bg-base-200 rounded-lg">
                                        ...
                                        <div class="flex gap-6 text-sm">
                                            ...
                                            >
                                                ...
                                                />
                                                <span
                                                    >Prev High: {meta.fractalData.dailyBias.previousDay.high.toFixed(
                                                        2,
                                                    )}</span
                                                >
                                            </div>
                                            ...
                                            >
                                                ...
                                                />
                                                <span
                                                    >Prev Low: {meta.fractalData.dailyBias.previousDay.low.toFixed(
                                                        2,
                                                    )}</span
                                                >
                                            </div>
                        ...
                        {#if !collapsedSections.faq1}
                            <div class="mt-4 pt-4 border-t border-base-300">
                                <p class="text-base-content/80">
                                    Fractal trading analysis identifies
                                    repeating patterns across different
                                    timeframes to predict price movements. Our
                                    AI analyzes these patterns to generate
                ...
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        ...
                        {#if !collapsedSections.faq2}
                            <div class="mt-4 pt-4 border-t border-base-300">
                                <p class="text-base-content/80">
                                    Our signals have an average accuracy of {stats.successRate}%.
                                    However, market conditions can change
                                    rapidly. Always use proper risk management
                                    and consider signals as part of your overall
                                    trading strategy.
                                </p>
                            </div>
                        {/if}
